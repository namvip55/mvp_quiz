...
export default function Home() {
  return (
    <div className="ui-page ui-page-decor-home flex min-h-[80vh] max-w-4xl flex-col items-center justify-center">
      ...
      <div className="mt-10 grid w-full gap-4 sm:grid-cols-2">
        <LoadingLink href="/create" className="ui-card-soft block p-6 text-center transition hover:border-primary">
        ...
        <LoadingLink href="/exams" className="ui-card-soft block p-6 text-center transition hover:border-primary" label="Đang tải danh sách đề thi..." enableLoading>
